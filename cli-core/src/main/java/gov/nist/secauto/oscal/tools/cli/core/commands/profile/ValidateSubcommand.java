...
public class ValidateSubcommand extends AbstractValidationSubcommand {
  ...
  public String getDescription() {
    return "Validate that the specified OSCAL Profile is well-formed";
  }

  @Override
  protected List<Source> getSchemaSources() throws IOException {
    List<Source> retval = new LinkedList<>();
    retval.add(XMLOperations.getStreamSource(OscalBindingContext.class.getResource("/schema/xml/oscal_profile_schema.xsd")));
    return Collections.unmodifiableList(retval);
  }

  @Override
  protected InputStream getJsonSchema() {
    return OscalBindingContext.class.getResourceAsStream("/schema/json/oscal_profile_schema.json");
  }
}
