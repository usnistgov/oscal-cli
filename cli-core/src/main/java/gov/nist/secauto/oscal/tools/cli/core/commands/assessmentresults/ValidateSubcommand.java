...
public class ValidateSubcommand extends AbstractValidationSubcommand {
  ...
  public String getDescription() {
    return "Validate that the specified OSCAL Assessment Results is well-formed";
  }

  @Override
  protected List<Source> getSchemaSources() throws IOException {
    List<Source> retval = new LinkedList<>();
    retval.add(XMLOperations.getStreamSource(OscalBindingContext.class.getResource("/schema/xml/oscal_assessmen-results_schema.xsd")));
