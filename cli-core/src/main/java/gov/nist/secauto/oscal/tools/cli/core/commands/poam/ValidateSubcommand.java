...
public class ValidateSubcommand extends AbstractValidationSubcommand {
  ...
  public String getDescription() {
    return "Validate that the specified OSCAL Plan of Actions and Milestones is well-formed";
  }

  @Override
  protected List<Source> getSchemaSources() throws IOException {
    List<Source> retval = new LinkedList<>();
    retval.add(XMLOperations.getStreamSource(OscalBindingContext.class.getResource("/schema/xml/oscal_poam_schema.xsd")));
