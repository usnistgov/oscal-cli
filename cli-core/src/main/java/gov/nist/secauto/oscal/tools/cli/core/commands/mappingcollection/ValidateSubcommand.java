...
public class ValidateSubcommand
  ...
  public List<Source> getXmlSchemas() throws IOException {
    ...
    retval.add(XmlUtil.getStreamSource(OscalBindingContext.class.getResource("/schema/xml/oscal_mapping_schema.xsd")));
  ...
  public JSONObject getJsonSchema() {
    return JsonSchemaContentValidator.toJsonObject(
        OscalBindingContext.class.getResourceAsStream("/schema/json/oscal_mapping_schema.json"));
  }
}
