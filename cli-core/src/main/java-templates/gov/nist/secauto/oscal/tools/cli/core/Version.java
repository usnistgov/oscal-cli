...
import gov.nist.secauto.oscal.tools.cli.framework.VersionInfo;
...
public class Version implements VersionInfo {
  ...
  public void generateExtraInfo(PrintStream out) {
    out.println(ansi().a("OSCAL version ").bold().a(OscalVersion.OSCAL_BRANCH).boldOff().a(" on commit ").bold().a(OscalVersion.OSCAL_COMMIT).reset());
  }
}
